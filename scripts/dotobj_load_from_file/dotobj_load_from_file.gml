...
var _use_array         = (argument_count > 6)? argument[6] : undefined;

var _buffer = buffer_load(_filename);
var _result = dotobj_load(_buffer, _vformat, _write_normals, _write_texcoords, _flip_texcoords, _reverse_triangles, _use_array);
