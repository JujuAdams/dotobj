...
//
var _material_array = undefined;
var _texture_array  = undefined;
        ...
        if ((_value == 10) || (_value == 13) || (_value == 32) || (_i >= _buffer_size))
        {
            ...
            if (_value != 32)
            {
                ...
                if (_line_data_list[| 0] == "newmtl")
                {
                    ...
                    var _material_array = dotobj_new_material(_library_name, _material_name);
                }
                ...
                else switch(_line_data_list[| 0]) //Use the first piece of data we read to determine what kind of line this is
                {
                    ...
                    case "Ns": //Specular exponent
                        _material_array[@ eDotObjMaterial.SpecularExp] = real(_line_data_list[| 1]);
                    break;
                    
                    case "Tr": //Transparency
                        _material_array[@ eDotObjMaterial.Transparency] = real(_line_data_list[| 1]);
                    break;
                    ...
                    case "Tf": //Transmission filter
                        switch(_line_data_list[| 1])
                        {
                            ...
                            default:
                                _material_array[@ eDotObjMaterial.Transmission] = make_colour_rgb(255*real(_line_data_list[| 1]), 255*real(_line_data_list[| 2]), 255*real(_line_data_list[| 3]));
                            break; //Using RGB
                        }
                    break;
                    ...
                    case "illum": //Illumination model
                        switch(_line_data_list[| 1])
                        {
                            ...
                            case "10": //Cast shadows onto invisible surfaces
                                _material_array[@ eDotObjMaterial.IlluminationModel] = real(_line_data_list[| 1]);
                            break;
                    ...
                    case "d": //Dissolve
                        ...
                        {
                            _material_array[@ eDotObjMaterial.Dissolve] = -real(_line_data_list[| 1]);
                        }
                        else
                        {
                            _material_array[@ eDotObjMaterial.Dissolve] = real(_line_data_list[| 1]);
                    ...
                    case "sharpness": //Reflection sharpness
                        _material_array[@ eDotObjMaterial.Sharpness] = real(_line_data_list[| 1]);
                    break;
                    
                    case "Ni": //Optical density
                        _material_array[@ eDotObjMaterial.OpticalDensity] = real(_line_data_list[| 1]);
                    break;
                    ...
                    case "bump": //"Bump" map (normal map)
                        var _sprite = dotobj_new_external_sprite(_line_data_list[| 1]);
                        _texture_array = (_sprite >= 0)? dotobj_new_texture(_sprite, 0, _line_data_list[| 1]) : undefined;
                        
                        switch(_line_data_list[| 0])
                        {
                            case "map_Ka":    _material_array[@ eDotObjMaterial.AmbientMap    ] = _texture_array; break;
                            case "map_Kd":    _material_array[@ eDotObjMaterial.DiffuseMap    ] = _texture_array; break;
                            case "map_Ks":    _material_array[@ eDotObjMaterial.SpecularMap   ] = _texture_array; break;
                            case "map_Ke":    _material_array[@ eDotObjMaterial.EmissiveMap   ] = _texture_array; break;
                            case "map_Ns":    _material_array[@ eDotObjMaterial.SpecularExpMap] = _texture_array; break;
                            case "map_d":     _material_array[@ eDotObjMaterial.DissolveMap   ] = _texture_array; break;
                            case "map_decal":
                            case "decal":     _material_array[@ eDotObjMaterial.DecalMap      ] = _texture_array; break;
                            case "map_disp":                                                  
                            case "disp":      _material_array[@ eDotObjMaterial.AmbientMap    ] = _texture_array; break;
                            case "map_bump":                                                  
                            case "bump":      _material_array[@ eDotObjMaterial.NormalMap     ] = _texture_array; break;
                        }
                    break;
